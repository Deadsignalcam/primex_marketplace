      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const PrimeXHomeUnifiedMarketplaceFeed(),
            liveAdsPromotions(),
            const SizedBox(height: 14),
...
class PrimeXHomeUnifiedMarketplaceFeed extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>> loadItems() async {
    ...
    Future<void> addCollection(String collection, String type) async {
      try {
    ...
    await addCollection('professional_live_feed', 'post');
    await addCollection('live_feed', 'post');
    await addCollection('listings', 'listing');
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (items.isEmpty)
                const Text(
                  'Posts and listings will appear here.',
